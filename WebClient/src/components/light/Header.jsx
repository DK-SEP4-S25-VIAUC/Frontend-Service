  ...
  return (
    <div className="flex items-center justify-between mb-">
      <div className="flex items-center gap-2">
        <LightBulbIcon className="h-5 w-5 text-emerald-500 dark:text-emerald-400" />
        <h3 className="text-base font-medium text-gray-800 dark:text-gray-100">Light level</h3>
      </div>
      <button
        onClick={onRefresh}
