...
export default function SoilHumidityAlert() {
    ...
    return (
        <div className="mx-auto w-full">
            <div className="bg-white dark:bg-gray-800 shadow-md dark:shadow-md border border-gray-100 dark:border-gray-700 rounded-xl p-4 sm:p-6 md:p-8">
                ...
                <div className="mt-2 max-w-full sm:max-w-sm p-6 bg-white dark:bg-gray-700 rounded-xl shadow-md dark:shadow-lg">
